...
boards = [
  {
    ...
    description: '速報性・公共性のないスレッド、ニュース以外のスレッドは禁止です。'
  },
  {
    name: '科学ニュース',
    category: 'ニュース',
  ...
  },
  {
    ...
    description: 'Rubyについての掲示板です。Ruby on Railsに関する情報もここで話し合いましょう。'
  },
  {
    name: 'JavaScript',
    category: 'プログラミング',
  ...
  },
  {
    ...
    description: 'インスタントラーメンやカップやきそばなど、お湯だけまたは火にかけるだけのように、簡単かつ短時間に調理可能なめん類の話題を扱う掲示板です。※別途つゆ・具材が必要な製品、麺類以外のインスタント食品などは対象外です。'
  }
]
